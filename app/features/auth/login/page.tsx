...
const inputClass='w-full bg-white border border-[#d4c9b0] rounded-xl px-4 py-3 text-sm text-[#1a3d2b] placeholder;text-[#a09880] focus:outline-none focus:border-[#1a3d2b] transition-colors diabled:opacity-50';

const ERROR_CODES: Record<string, string>={
    INVALID_CREDENTIALS: 'Email or password is incorrect',
    ACCOUNT_DEACTIVATED: 'Your account has been deactivated Contact Support',
    misssing_credentials: 'Please enter both email and password',
            ...
            >
                <div className="absolute top-0 left-0 right-0 h-0.75 bg-[#e8c84a]"/>
                    <div className="absolute right-0 top-0 bottom-0 w-20 flex items-center justify-center overflow-hidden pointer-events-none">
                        <span className="text-[8rem] font-black text-white/4 uppercase select-none whitespace-nowrap"
            ...
            >
                <div className="w-full max-w-sm">
                    ...
                    <p className="text-center text-[11px] text-[#8a9a8e] mt-8">
                        No Account?{' '}
                        <Link href="/features/auth/register"
