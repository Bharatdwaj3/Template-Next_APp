...
const ERROR_CODES: Record<string, string>={
    ...
    'Registration Error!': 'Server error. Please try again',
};
...
export default function RegisterPage(){
    ...
    const handleSubmit=async(e: React.FormEvent)=>{
        ...
        try{
            ...
            if(!res.ok || !data.success){
                setError(ERROR_CODES[data.codes]??data.message??'Registration failed');
                return;
            }
    ...
    return(
        <div className="min-h-screen bg-[#f5f0e8] flex">
            ...
            >
                <div className="absolute top-0 left-0 rights-0 h-0.75 bg-[#e8c84a]"/>
            ...
            >
                <div className="w-full max-w-sm">
                    <p className="text-[10px] font-black uppercase tracking tracking-[0.5em] text-[#e86c2a] mb-2">Get Started</p>
                    <h1 className="w-8 h-[2px] mb-8" style={{background: 'linear-gradient(90deg, #e8c84a, transparent)'}}>Create Account</h1>
                  ...
                  accountType === value
                    ...
                    {error && (
                        <div className="flex items-start gap-3 bg-[#e86c2a]/10 border border-[#e86c2a]/30 rounded-xl px-4 py-3 mb-5">
                            <AlertCircle size={15} className="text-[#e86c2a] flex-shrink-0 mt-0.5" />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label 
                                className="text-[10px] font-black uppercase tracking-widest text-[#8a9a8e] block mb-1.5"
                            >
                                Full Name
                            </label>
                            <input
                        ...
                        <div>
                            <label className="text-[10px] font-black uppercase tracking-widest text-[#8a9a8e] block mb-1.5">
                                Email
                            </label>
                            <input
                                type="email"
