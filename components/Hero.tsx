...
export const Hero = () => {
  <header className="relative min-h-screen w-full flex bg-[#fgf0e8] overflow-hidden">
    ...
    <div className="absolute right-0 top-0 bottom-0 w-32 items-center justify-center overflow-hidden pointer-events-none z-0">
      <span
    ...
    <motion.div
      ...
      className='w-full lg:w-[42%] lg:min-w-100 flex flex-col justify-center px-8 lg:px-24 z-20 bg-[#1aed2b] relative'
    > 
      ...
      />
        ...
        <p className="text-base text-[#f5f0e8]/68 leading-relaxed mb-10 font-light max-w-sm">
          ...
          <span className="text-[#e8c84a] font-medium ml-1">
            earth&apos;s honest yield
          </span>.
        </p>
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="absolute bottom-8 left-16 xl:left-24 flex gap-8">
          {[['2,400+','Famers'],['18','Countries'],['100%','Organic']].map(([num, label])=>(
            <div key={label}>
      ...
      <div className='hidden lg:flex flex-1 relative items-center justify-center'>
        <div className='absolute inset-0 opacity-[0.04] bg-[radical-gradient(circle, #1a3d2b_1px, transparent_1pz)] bg-size-[28px_28px]'/>
        <motion.div
